import { Lightning, Img, Colors, Utils, Router } from "@lightningjs/sdk";
    ...
    static _template() {
        return {
            ...
            MoreInfo: {
                ...
                PlayButton: {
                    type: Button, y: 510, w: 90, h: 90, icon: 'images/play.png', content: {w: 70, h: 70}
                },
                Runtime: {
                    y: 536, x: 120, text: {fontFace: 'Regular', fontSize: 28, lineHeight: 28},
                }
            },
            MoreInfo2: {
